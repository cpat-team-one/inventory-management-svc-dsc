...
@org.junit.jupiter.api.DisplayName("StockItemController")
public class StockItemControllerTest {
    ...
    @Nested
    @org.junit.jupiter.api.DisplayName("Given [GET] /stock-items")
    public class GivenGetStockItems {
        @Test
        @org.junit.jupiter.api.DisplayName("When called then it should return a 200 status")
        public void when_called_should_return_200_status() throws Exception {
            mockMvc.perform(get("/stock-items"))
                    .andExpect(status().isOk());
        }
        @Test
        @org.junit.jupiter.api.DisplayName("When called then it should return an empty array")
        ...
        @Test
        @org.junit.jupiter.api.DisplayName("When called then it should return the results of the StockItemService")
